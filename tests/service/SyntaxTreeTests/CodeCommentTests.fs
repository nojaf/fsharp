...
"""
    ...
    match trivia with
    | [ CommentTrivia.LineComment mComment ] -> assertRange (2, 0) (2, 11) mComment
...
"""
    ...
    match trivia with
    | [ CommentTrivia.LineComment mComment ] -> assertRange (3, 0) (3, 11) mComment
    | _ -> Assert.Fail "Could not get valid AST"
...
"""
    ...
    match trivia with
    | [ CommentTrivia.LineComment mComment ] -> assertRange (2, 6) (2, 17) mComment
    | _ -> Assert.Fail "Could not get valid AST"
...
"""
    ...
    match trivia with
    | [ CommentTrivia.LineComment mComment ] -> assertRange (4, 14) (4, 25) mComment
    | _ -> Assert.Fail "Could not get valid AST"
...
"""
    ...
    match trivia with
    | [ CommentTrivia.BlockComment mComment ] -> assertRange (2, 6) (2, 13) mComment
    | _ -> Assert.Fail "Could not get valid AST"
...
"""
    ...
    match trivia with
    | [ CommentTrivia.BlockComment mComment ] -> assertRange (4, 6) (4, 13) mComment
    | _ -> Assert.Fail "Could not get valid AST"

[<Test>]
let ``comment at end of file`` () =
    let trivia = getCommentTrivia false "x // y"

    match trivia with
    | [ CommentTrivia.LineComment mComment ] -> assertRange (1, 2) (1, 6) mComment
    | _ -> Assert.Fail "Could not get valid AST"
