...
type SynExpr =
    ...
    | DotSet of targetExpr: SynExpr * longDotId: LongIdentWithDots * rhsExpr: SynExpr * range: range
    ...
    | NamedIndexedPropertySet of longDotId: LongIdentWithDots * expr1: SynExpr * expr2: SynExpr * range: range
...
type SynPat =
    ...
    | Named of ident: Ident * isThisVal: bool * accessibility: SynAccess option * range: range
...
type SynInterfaceImpl =
    | SynInterfaceImpl of interfaceTy: SynType * withKeyword: range option * bindings: SynBinding list * range: range
...
type SynModuleDecl =
    ...
    | DoExpr of debugPoint: DebugPointAtBinding * expr: SynExpr * range: range
