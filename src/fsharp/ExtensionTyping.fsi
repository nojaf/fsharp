...
module internal ExtensionTyping =
    ...
    and [<AllowNullLiteral; Sealed; Class>] ProvidedType =
    ...
    and [<AllowNullLiteral>] IProvidedCustomAttributeProvider =
    ...
    and [<AllowNullLiteral; Sealed; Class>] ProvidedAssembly =
    ...
    and [<AllowNullLiteral; AbstractClass>] ProvidedMemberInfo =
        member Name: string
        member DeclaringType: ProvidedType
        interface IProvidedCustomAttributeProvider

    and [<AllowNullLiteral; AbstractClass>] ProvidedMethodBase =
        inherit ProvidedMemberInfo
    ...
    and [<AllowNullLiteral; Sealed; Class>] ProvidedMethodInfo =
        inherit ProvidedMethodBase
        member ReturnType: ProvidedType
        member MetadataToken: int

    and [<AllowNullLiteral; Sealed; Class>] ProvidedParameterInfo =
        member Name: string
    ...
    and [<AllowNullLiteral; Class; Sealed>] ProvidedFieldInfo =
        inherit ProvidedMemberInfo
    ...
    and [<AllowNullLiteral; Class; Sealed>] ProvidedPropertyInfo =
        inherit ProvidedMemberInfo
    ...
    and [<AllowNullLiteral; Class; Sealed>] ProvidedEventInfo =
        inherit ProvidedMemberInfo
    ...
    and [<AllowNullLiteral; Class; Sealed>] ProvidedConstructorInfo =
        inherit ProvidedMethodBase
    ...
    and [<RequireQualifiedAccess; Class; Sealed; AllowNullLiteral>] ProvidedExpr =
    ...
    and [<RequireQualifiedAccess; Class; Sealed; AllowNullLiteral>] ProvidedVar =
        member Type: ProvidedType
        member Name: string
