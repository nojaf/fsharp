module internal PrintSignature.Context
...
let shortExpressionWithFallback (shortExpression: Context -> Context) fallbackExpression maxWidth startColumn (ctx: Context) =
...
let sepSpaceOrIndentAndNlnIfExpressionExceedsPageWidthUnlessStroustrup f (expr: Expr) (ctx: Context) =
    sepSpaceOrIndentAndNlnIfExceedsPageWidthUnlessStroustrup (isStroustrupStyleExpr ctx.Config expr) (f expr) (Expr.Node expr) ctx

let sepSpaceOrIndentAndNlnIfTypeExceedsPageWidthUnlessStroustrup f (t: Type) (ctx: Context) =
    sepSpaceOrIndentAndNlnIfExceedsPageWidthUnlessStroustrup (isStroustrupStyleType ctx.Config t) (f t) (Type.Node t) ctx
