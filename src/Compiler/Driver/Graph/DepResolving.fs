module internal FSharp.Compiler.Graph.DepResolving

#nowarn "40"

open System
open System.Collections.Generic
open FSharp.Compiler.Graph.FileInfoGathering
open FSharp.Compiler.Graph.Graph
open FSharp.Compiler.Graph.Types
open FSharp.Compiler.Graph.ASTVisit
...
module internal AutomatedDependencyResolving =
    ...
    let emptyTrie () : TrieNode =
        {
            TrieNode.Children = Dictionary(0)  // Dictionary([])
